...
export const UpdateInstagramChannelBody = t.Object({ label: t.Optional(t.String({ minLength: 1, maxLength: 100 })), niches: t.Optional(t.Array(t.String({ maxLength: 64 }), { maxItems: 20 })) });
export type TUpdateInstagramChannelBody = typeof UpdateInstagramChannelBody.static;
